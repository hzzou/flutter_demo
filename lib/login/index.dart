...
class _FormState extends State<SignUpForm>{
  ...
  void printBasic(){
    print(ScreenUtil().setSp(60));
    // dpx
    print(ScreenUtil().pixelRatio);
    // 此处的scale不是dpx的倒数,而是设计稿的高(或者宽)和屏幕高(或宽)之比，二者中取小者
...
class SignUpScreen extends StatelessWidget{
  ...
  Widget build(BuildContext context){
    return Scaffold(
        ...
        body: Center(
            child: SizedBox(
              // 700 超过最大宽度就只取最大宽度了, 但是实际上我们要750才会填满, 所以使用工具
              // width: ScreenUtil().setWidth(700), //
              // width: 0.8.sw, //是ScreenUtil的写法表示0.8个屏幕宽度
              // height: 0.5.sh, // 0.5个屏幕高度
              width: 700.w,
              height: 0.8.sh,
              // width: 700,
              child: const Card(
